...
# TODO - Step 0 - import os for rank, etc
...
# TODO - Step 0 - import torch distributed,
# torch distributed fsdp as fsdp,
# (optional) import torch.distributed.device_mesh
...
def main(args):
    # define torch device
    # TODO - step 0 - init_process_group
    local_rank = 0
    ...
    # TODO (optional) have only local rank 0 download
