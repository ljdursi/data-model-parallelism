...
# TODO Step 1 add os import so we can get at environment variables w/ os.environ.get()
import torch
...
# TODO Step 1 import torch distributed as dist for barrier, process_group operations, reductions
...
def main(args):
    # define torch device
    # TODO Step 1 - get LOCAL_RANK with os.environ.get to set the GPU appropriately
    local_rank = 0
    device = torch.device(f"cuda:{local_rank}" if torch.cuda.is_available() else "cpu")

    # TODO Step 1 - set up process group
    ...
    # TODO Step 1 only need to download data once per node but everyone needs to know information about the dataset
    ...
    with profile(activities=[ProfilerActivity.CPU, ProfilerActivity.CUDA],
                 on_trace_ready=torch.profiler.tensorboard_trace_handler('/workspace/logs/eurosat_pipeline_step0'),
        ...
        for epoch in range(args.epochs):
            ...
            # TODO step 1 - synchronize with barrier at the end of each epoch, or else 
            # stats will be wrong 
            ...
            # TODO step 1 Just have rank 0 print this out
            print(
    ...
    # TODO step 1- we don't need to have all ranks print this
    print("Finished Training")
    
    # TODO step 1- we should only have one rank save the model
    save_path = "./eurosat_net.pth"
    torch.save(net.state_dict(), save_path)

    # TODO step 1- get rid of the process group
